                ...
                <table class="table table-border table-bordered table-hover table-bg table-sort">
                    ...
                    <tbody>
                        <script id="menu-template" type="text/x-handlebars-template">
                            {{#each this}}
                            <tr class="text-c">
                                <td><input type="checkbox" value="1" name="uniqueIndex"></td>
                                <td>{{id}}</td>
                                <td><u style="cursor:pointer" class="text-primary" onclick="member_show('张三','member-show.html','10001','360','400')">{{userCode}}</u></td>
                                <td>{{userName}}</td>
                                <td class="text-l">{{mobile}}</td>
                                <td>{{createTime}}</td>
